...
const NewsCard = () => (
  <div className="absolute rounded-3xl rounded-br-none dark:border dark:border-gray bg-white/5 dark:bg-black/1 top-[68%] left-[32.5%] max-w-[400px] backdrop-blur-sm shadow hidden xl:block">
